...
export async function handleLogin(email, password) {
    ...
    if (!email || !password) {
        ...
        console.warn("Login failed: email or password empty");
        return false;
    }
    ...
    if (!client) {
        const errorMsg = "Network error, Supabase not ready. Check: 1) Supabase script loaded 2) VPN/Network 3) Console errors";
